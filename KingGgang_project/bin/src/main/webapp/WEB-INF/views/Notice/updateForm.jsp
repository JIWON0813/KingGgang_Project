	...
	<form name="f" action="update.notice" method="post" onsubmit="return check()">
		...
		<table border="1" width="70%">
			...
			<tr>
				...
				<td><input type="text" name="subject" class="box" size="40" value="${notice.subject}"></td>
			</tr>
			<tr>
				<th width="20%" bgcolor="yellow">내 용</th>
				<td><textarea name="content" rows="10" cols="40" class="box">${notice.content}</textarea></td>
			</tr>
			<tr>
