...
<div align="center" class="container">
	<br>
	<form name="f" action="Q_updatepro.board" method="post" onsubmit="return check()">	
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" name="name" size="40" value="${Quest.name }"></td>
			</tr>
			<tr>
				<th>이메일</th>
				<td><input type="text" name="email" size="40" value="${Quest.email }"></td>
			</tr>
			<tr>
				<th width="20%">내 용</th>
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="password" name="passwd" size="40" value="${Quest.passwd }">
